...
const Categories = ({ category }) => {
    ...
    return (
        ...
        <div class="  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="px-5 pb-5">
                <div href="#">
                    <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{modelName}</h5>
                </div>
                <div href="#">
                    <h5 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">{desc}</h5>
                </div>
